...
window.addEventListener("load", function () {
	...
	let ccTopOffset = "50px";
	let ccNormalOffset = "50px";
...
`;
	...
	ccFunc = (e) => {
		...
		if (window.innerWidth > 992) {
			...
			$("#contents-col").followTo(document.body.scrollHeight - 0, ccTopOffset);
		} else {
			$("#contents-col").css("top", ccNormalOffset);
			$("#contents-col").followTo(document.body.scrollHeight - 0, ccNormalOffset);
		}
	};
